...
class Rectangle(Forme):
    ...
    def StartType(self):
        ...
        posi = (self.x, self.y,
                ...
                self.x + (20 * self.Zoom), self.y + (h * self.Zoom), self.x + (15 * self.Zoom),
                self.y + (h * self.Zoom) + (5 * self.Zoom), self.x + (10 * self.Zoom),
                self.y + (h * self.Zoom) + (5 * self.Zoom), self.x + (5 * self.Zoom), self.y + (h * self.Zoom),
